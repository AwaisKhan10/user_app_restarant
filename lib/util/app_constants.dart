...
class AppConstants {
  static const String appName = 'WeeKook';
  static const double appVersion = 7.2;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const String webHostedUrl = 'https://weekook.com';

  static const String baseUrl = 'https://portal.weekook.com';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.spanish, languageName: 'Français', countryCode: 'FR', languageCode: 'fr'),
